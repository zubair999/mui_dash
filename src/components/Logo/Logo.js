...
const Logo = () => {
    ...
    return (
         ...
         */
        <>
            <img src = "https://vishwasports.s3.ap-south-1.amazonaws.com/gravity.png" alt="logo" width="100"/>
            {/* <svg width="118" height="35" viewBox="0 0 118 35" fill="none" xmlns="https://vishwasports.s3.ap-south-1.amazonaws.com/gravity.png">
                <path
